...
const Landing: React.FC<LandingProps> = ({ onStartCreating }) => {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-800 font-sans selection:bg-amber-100 selection:text-amber-900 antialiased">
      {/* 1. CORPORATE HEADER NAVIGATION */}
      <nav className="max-w-7xl mx-auto px-6 py-5 flex flex-col sm:flex-row justify-between items-center border-b border-slate-200/80 gap-4">
        <div className="flex items-center space-x-3">
          <div className="w-9 h-9 rounded-xl bg-gradient-to-tr from-amber-500 via-yellow-400 to-cyan-400 flex items-center justify-center font-black text-black text-base shadow-[0_0_15px_rgba(245,158,11,0.15)]">
            E
          </div>
          <div className="flex flex-col">
            <span className="text-md font-extrabold tracking-widest bg-gradient-to-r from-slate-900 via-slate-800 to-slate-600 bg-clip-text text-transparent">
              E-BIX SOLUTIONS
            </span>
            <span className="text-[10px] text-cyan-600 font-mono tracking-wider uppercase">
        ...
        <div className="flex items-center space-x-6 text-sm font-medium text-slate-600">
          ...
          <a
            ...
            className="flex items-center space-x-1.5 px-3 py-1 bg-white border border-slate-200 text-slate-700 hover:text-slate-950 rounded-lg hover:bg-slate-50 transition-colors shadow-sm"
          >
            <span>GitHub</span>
          </a>
        </div>
      ...
      <header className="max-w-7xl mx-auto px-6 pt-12 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          <div className="inline-flex items-center space-x-2 bg-amber-50 border border-amber-200/60 px-3 py-1.5 rounded-full text-xs text-amber-700 font-semibold tracking-wide">
          ...
          <h1 className="text-4xl sm:text-6xl font-black tracking-tight leading-none text-slate-900">
            පින්බර පොසොන් <br />
            <span className="bg-gradient-to-r from-amber-600 via-amber-500 to-cyan-600 bg-clip-text text-transparent">
              පෝය දිනක් වේවා!
            </span>
          </h1>
          ...
          <p className="text-slate-600 text-lg leading-relaxed max-w-xl">
            ...
            <span className="text-slate-900 font-semibold">E-BIX Solutions</span>{" "}
          ...
          <div className="pt-2 flex flex-col sm:flex-row gap-4">
            <a href="/create">
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-amber-500 via-yellow-400 to-amber-600 text-slate-950 font-extrabold rounded-xl shadow-lg shadow-amber-500/20 hover:scale-[1.01] active:scale-[0.99] transition-all duration-200"
              >
            ...
            <a
              href="#heritage"
              className="px-8 py-4 bg-white border border-slate-200 rounded-xl font-semibold text-center hover:bg-slate-50 text-slate-700 hover:text-slate-950 transition-all shadow-sm"
            >
          ...
          <div className="pt-6 border-t border-slate-200/80 flex items-center space-x-4 text-xs font-mono text-slate-500">
        ...
        <div className="lg:col-span-6 relative flex flex-col items-center">
          {/* Ambient Glows */}
          <div className="absolute inset-0 bg-cyan-500/10 rounded-full blur-3xl -z-10 animate-pulse"></div>

          {/* Active Canvas Mock Screen */}
          <div className="w-full max-w-md bg-white border border-slate-200/80 p-4 rounded-2xl shadow-xl backdrop-blur-md">
            ...
            <div className="relative rounded-xl overflow-hidden group border border-slate-200/40 shadow-inner">
              <img
                ...
                <button
                  ...
                  className={`py-2 text-xs font-semibold rounded-lg border transition-all ${
                    activeThemePreview === t
                      ? "bg-slate-50 border-amber-300 text-amber-700 shadow-sm"
                      : "bg-slate-100/80 text-slate-500 border-transparent hover:border-slate-200 hover:bg-slate-200/50"
                  }`}
                >
                  {t.toUpperCase()}
                </button>
      ...
      <section
        id="heritage"
        className="bg-slate-100/60 border-y border-slate-200 py-24 px-6 relative"
      >
        <div className="max-w-7xl mx-auto space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {/* Motif 1 */}
            <div className="p-6 bg-white border border-slate-200/85 rounded-2xl space-y-4 hover:border-slate-300 hover:shadow-md transition-all">
            ...
            <div className="p-6 bg-white border border-slate-200/85 rounded-2xl space-y-4 hover:border-slate-300 hover:shadow-md transition-all">
              ...
              <h3 className="text-lg font-bold text-slate-800">Full Moon Aura</h3>
              <p className="text-slate-600 text-sm leading-relaxed">
      ...
      >
        ...
        <div className="lg:col-span-7 bg-white border border-slate-200/80 rounded-2xl p-6 font-mono text-xs text-slate-600 shadow-lg overflow-x-auto">
          <p className="text-slate-400 mb-2">
            // Sample Output Node Schema Reference
          </p>
          <p>
            <span className="text-purple-600">const</span> PosonCardMetaData =
            &#123;
          </p>
          <p className="pl-4">
            engine:{" "}
            <span className="text-amber-700">"E-BIX Web Canvas Core"</span>,
          </p>
          <p className="pl-4">
            localization:{" "}
            <span className="text-amber-700">"Sinhala Unicode Supported"</span>,
          </p>
          <p className="pl-4">
            motifs: [<span className="text-cyan-600">"Mihintale_Stupa"</span>,{" "}
            <span className="text-cyan-600">"Deer_Silhouette"</span>,{" "}
            <span className="text-cyan-600">"Full_Moon"</span>],
          </p>
          <p className="pl-4">
            standardGreeting:{" "}
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 flex justify-between items-center text-[10px] text-slate-400">
            ...
            <span className="text-green-600">● STABLE STATE</span>
          </div>
        </div>
      </section>

      {/* 5. BRAND FOOTER */}
      <footer className="bg-white border-t border-slate-200/80 py-12 text-center text-slate-500 text-sm px-6">
