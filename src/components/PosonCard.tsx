...
const TEMPLATES = [
  {
    id: "greeting1",
    label: "Poson Poya",
    image: "/greetings/Arahat_Mahinda_meeting_King_Deva…_202606262302.jpeg",
    accent: "#f5c26b",
  },
  {
    id: "greeting2",
    label: "Blessed Day",
    image: "/greetings/Arahat_Mahinda_meeting_King_Deva…_202606262305 (1).jpeg",
    accent: "#f5c26b",
  },
  {
    id: "greeting3",
    label: "Lotus Garden",
    image: "/greetings/Buddha_silhouette_teaching_mudra…_202606252240.jpeg",
    accent: "#8ef5c0",
  },
];
  ...
  return (
    <div
      style={{
        width: "100%",
        height: "100%",
        aspectRatio: "3/4", // ← portrait to match your images
        maxWidth: "100%", // ← narrower to suit portrait
        borderRadius: 12,
        overflow: "hidden",
        position: "relative",
        backgroundImage: `url(${template.image})`,
        backgroundSize: "contain", // ← show entire picture, no crop
        backgroundRepeat: "no-repeat",
        backgroundPosition: "center",
        backgroundColor: "#060d1f", // ← fills any letterbox edges
...
export default function PosonCard({ onClose }: { onClose?: () => void }) {
  ...
  const pickRandom = useCallback(
    (
      currentUsed: number[],
    ): { variant: CardVariant; idx: number; newUsed: number[] } => {
  ...
  const handleNativeShare = async () => {
    ...
    try {
      ...
      const file = new File([blob], "Poson-Greeting.png", {
        type: "image/png",
      });
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            position: "relative",
            boxShadow:
              "0 32px 80px rgba(0,0,0,0.7), 0 0 0 1px rgba(201,146,58,0.08)",
            marginTop: "auto",
            marginBottom: "auto",
          }}
        >
          ...
          >
            ...
            {generated && (
              ...
              >
                Card {cardCount} · {currentCard?.template.label} · {DECK.length}{" "}
            ...
            {!generated && (
              <button
                ...
                style={{
                  ...
                  border: "none",
                  background:
                    "linear-gradient(135deg, #c9923a 0%, #f5c26b 50%, #c9923a 100%)",
                  color: "#1a0a00",
                  fontFamily: "Inter, sans-serif",
                  fontWeight: 700,
                  fontSize: 14,
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div className="share-btn-row">
                ...
                {"share" in navigator && (
                  <ShareBtn
                    icon={
                      capturing ? <Spinner color="#c9923a" /> : <ShareIcon />
                    }
          ...
          {toastMsg && (
            <div
              ...
              style={{
                ...
                background:
                  toastType === "success"
                    ? "rgba(142,245,192,0.1)"
                    : "rgba(245,100,100,0.1)",
